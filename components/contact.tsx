      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white">Contáctanos directamente</h3>
            ...
            <div className="space-y-6">
              <Card className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 group">
                <CardContent className="p-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center space-x-4 relative z-10">
                    <div className="bg-gradient-to-br from-blue-500 to-primary p-3 rounded-2xl shadow-lg transform group-hover:scale-110 transition-transform duration-300">
              ...
              <Card className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 group">
                <CardContent className="p-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center space-x-4 relative z-10">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">Envíanos un email</h4>
                      <Link
                        href={`mailto:${email}`}
                        className="text-primary hover:text-primary/80 text-lg font-medium break-all transition-colors duration-300"
              ...
              <Card className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 group">
                <CardContent className="p-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-600/5 to-teal-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <div className="flex items-center space-x-4 relative z-10">
                    <div className="bg-gradient-to-br from-green-600 to-teal-500 p-3 rounded-2xl shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                      <MessageSquare className="h-6 w-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">WhatsApp</h4>
                      <p className="text-gray-600 dark:text-gray-300 mb-3">
                        Escríbenos por WhatsApp para una respuesta rápida sobre mármoles y granitos
                      </p>
                      <Button
                        asChild
                        className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-teal-500 hover:from-teal-500 hover:to-green-600 transition-all duration-300 transform hover:scale-105"
                      >
                        <Link
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
              Información de Contacto de Ropema Rubio
            </h3>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 group">
                <CardContent className="p-6 flex items-start space-x-4 relative overflow-hidden">
                  ...
                  <div className="bg-gradient-to-br from-red-500 to-orange-500 p-3 rounded-2xl flex-shrink-0 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                    <MapPin className="h-6 w-6 text-white" />
                  </div>
                  <div className="relative z-10">
                    <h4 className="font-semibold mb-1 text-gray-900 dark:text-white">Dirección</h4>
              ...
              <Card className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 group">
                <CardContent className="p-6 flex items-start space-x-4 relative overflow-hidden">
                  ...
                  <div className="bg-gradient-to-br from-purple-500 to-pink-500 p-3 rounded-2xl flex-shrink-0 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                    <Clock className="h-6 w-6 text-white" />
                  </div>
                  <div className="relative z-10">
                    <h4 className="font-semibold mb-1 text-gray-900 dark:text-white">Horario</h4>
                    <p className="text-gray-600 dark:text-gray-300">
                      Lun - Vie: 7:00 - 15:00
                      <br />
